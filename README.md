...
stack?
```  
[Решение](https://github.com/Wegnagun/adventofcode2022/blob/main/day_5/day_5_first_part.py)  
[To the list ^](#list)  
____  
```  
--- Part Two ---
...
marker is detected?
```  
[Решение](https://github.com/Wegnagun/adventofcode2022/blob/main/day_6/day_6_first_part.py)  
[To the list ^](#list)  
____  
```  
--- Part Two ---
...
```  
[notyet](https://github.com/Wegnagun/adventofcode2022/blob/main/day_6/day_6_second_part.py)  
[To the list ^](#list)  
____  